  ...
  return (
    <div className="w-full max-w-6xl mx-auto px-4 py-16">
      <div className="text-center mb-12">
        ...
        <p className="text-lg text-on-surface-variant max-w-2xl mx-auto font-medium">Chettinad Health City operates {DEPARTMENTS.length} departments staffed by over 200 specialist physicians.</p>
      </div>
